...
<html lang="en">
  ...
  <ul class="navbar-nav">
    ...
    <div class="container">
        ...
        ?>
        <form method="post" id="register_form" action="<?= base_url('auth/register')?>" enctype="multipart/form-data">
            <div class="row">
            ...
            <input name="register" class="btn btn-primary mt-5" type="submit" value="Submit" id="submit" />
        </form>
    </div>
